...
const SuggestionsPanel = () => {
  ...
  return (
    <div className="hidden xl:block w-[300px] pl-6 pt-6 flex-shrink-0">
      {/* Trending */}
      <div className="bg-card rounded-3xl p-5 border border-border shadow-card mb-4">
        <div className="flex items-center gap-2 mb-4">
          <TrendingUp className="w-5 h-5 text-primary" />
          <h3 className="font-display font-bold text-foreground text-sm">Trending Waves</h3>
        </div>
      ...
      {users && users.length > 0 && (
        <div className="bg-card rounded-3xl p-5 border border-border shadow-card">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="font-display font-bold text-foreground text-sm">Discover People</h3>
          </div>
